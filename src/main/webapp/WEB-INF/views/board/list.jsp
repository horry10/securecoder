...
<html>
	...
	<body>
		...
		<form name="search_form" method="post" action="/board/list.do">
		...
		<table border="1" style="width: 600px">
			...
			<tr>
				<td>${row.getRownuma()}</td>
				<td>
					<!-- 검색조건, 검색 키워드, 현재 페이지를 유지하기 위해 -->
					<a href="${path}/board/detail.do?bno=${row.getBno()}&curPage=${map.boardPager.getCurPage()}&searchOption=${map.searchOption}&keyword=${map.keyword}">
						${row.getTitle()}
					</a>
				</td>
				<td>${row.getWriter()}</td>
